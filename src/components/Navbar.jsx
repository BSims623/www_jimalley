...
export default function Navbar() {
  ...
  return (
    <nav className={styles.navbar}>
      <Link href="/">
        <span className={styles.title}>Jim Alley</span>
      </Link>
      <ul className={styles.nav_links_container}>
        ...
        <li>
          <Link
            className={`${styles.nav_link} ${pathname.includes("/mayas-dance") && styles.nav_link_active}`}
            href="/mayas-dance"
          >
            Maya&apos;s Dance
          </Link>
        ...
        <li>
          <Link
            className={`${styles.nav_link} ${pathname.includes("/short-stories") && styles.nav_link_active}`}
            href="/short-stories"
          >
            Short Stories
          </Link>
