        ...
        <div className={styles.content_container}>
          ...
          <div className="paragraph_container">
            ...
            <p className={styles.paragraph}>Now, a lifetime later, I&apos;ve written probably 150 short stories, many essays, and three
              ...
              literary magazines; my essays in an on-line journal, and my debut novel, <em>Maya&apos;s Dance</em>, is in final editing and will soon be available to the public.</p>
            <p>Please learn more about <Link className={styles.link} href="/about">me</Link>, read an excerpt from my upcoming novel, <Link className={styles.link} href="mayas-dance"><em>Maya&apos;s Dance</em></Link>, or read several of my <Link className={styles.link} href="short-stories">short stories</Link> on this site.
            </p>
          </div>
