...
export const metadata = {
  title: "Maya's Dance",
  description: "Maya's Dance stems from my experiences as a Spanish-speaking welfare worker in Santa Barbara, California. The novel careens through the traps and pitfalls of the welfare system, the tyranny of living with a mentally disturbed parent, and the efforts of a naïve young welfare worker to make a name for himself by rescuing an at-risk child."
}

export default function MayasDance() {
  return (
    <main className={styles.main}>
      <div className={styles.content_container}>
        ...
        <div className="paragraph_container">
          ...
          <p><em>Maya's Dance</em> stems from my experiences as a Spanish-speaking welfare worker in{" "}
        ...
        <Link href="/mayas-dance/chapter-1/page-1"><button className={`btn ${styles.btn}`}>Maya&apos;s Dance</button></Link>
      </div>
    </main>
  );
}